const invitationConfig = {
  ...
  unlockCode: "34",
  riddleText: "Die benoetigte Zahl entspricht dem Alter, das nach Vollzug des vorgeworfenen Lebensjahres erreicht wird.",
...
const fieldMap = {
  ...
  inviteTitle: `Geburtstagseinladung fuer ${invitationConfig.birthdayPersonName}`,
  settlement: `Von weiteren Massnahmen kann abgesehen werden, wenn Sie am ${invitationConfig.date} um ${invitationConfig.time} in ${invitationConfig.location} persoenlich erscheinen, gratulieren und durch angemessene Mitwirkung an Speisen und Getraenken zur Verfahrensbeendigung beitragen.`,
